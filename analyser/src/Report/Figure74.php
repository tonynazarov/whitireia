...
readonly class Figure74 extends Figure
{
    ...
    {
        return 'Figure 74. The distribution of top 300 skills by groups in quantitative terms (number of jobs) for Job services.';
    }
