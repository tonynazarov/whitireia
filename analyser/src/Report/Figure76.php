...
readonly class Figure76 extends Figure
{
    ...
    {
        return 'Figure 76. The distribution of top 30 skills by groups in quantitative terms (number of jobs) for Job services.';
    }
