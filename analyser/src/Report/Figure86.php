...
readonly class Figure86 extends Figure
{
    protected function getTitle(): string
    {
        return 'Figure 86. Mention of AI-related technologies among vacancies in the context of the specified skills (Job Services).';
    }
