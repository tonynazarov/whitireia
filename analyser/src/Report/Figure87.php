...
readonly class Figure87 extends Figure
{
    protected function getTitle(): string
    {
        return 'Figure 87. The quantity of times of Industries mentioned according to the dataset collected from the Adzuna resource.';
    }
