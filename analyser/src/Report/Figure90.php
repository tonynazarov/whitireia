...
readonly class Figure90 extends Figure
{
    protected function getTitle(): string
    {
        return 'Figure 90. Distribution of vacancies by job keywords for headings in Latin font without grouping by unique value.';
    }
